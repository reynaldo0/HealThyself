...
const ArrowLeft = ({ onClick }) => {
  return (
    <div
      className="group absolute -left-2 md:-left-5 z-10 top-1/2 transform -translate-y-1/2 md:flex items-center justify-center w-8 h-8 md:w-12 md:h-12 rounded-full hover:bg-child-light text-secondary bg-transparent border-2 border-child-light hover:text-primary transition duration-300 cursor-pointer hidden"
      onClick={onClick}
    >
      <span className="text-lg text-child-light group-hover:text-white">
...
const ArrowRight = ({ onClick }) => {
  return (
    <div
      className="group absolute -right-2 md:-right-5 z-10 top-1/2 transform -translate-y-1/2 md:flex items-center justify-center w-8 h-8 md:w-12 md:h-12 rounded-full hover:bg-child-light text-secondary bg-transparent border-2 border-child-light hover:text-primary transition duration-300 cursor-pointer hidden"
      onClick={onClick}
    >
      <span className="text-lg group-hover:text-white text-child-light">
        <svg width="17" height="33" viewBox="0 0 17 33" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const defaultImage = '/assets/carousel/default-image.jpg'; 
