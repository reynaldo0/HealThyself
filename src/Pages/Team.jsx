        ...
        >
          ...
          <SwiperSlide>
            <div className="group transition-all bg-white p-4 rounded-xl shadow border border-gray-200 text-center ease-in-out hover:border-2 hover:border-secondary hover:bg-secondary hover:text-white flex flex-col items-center h-full">
              ...
              <p className="text-gray-600 text-sm ease-in-out group-hover:text-white">UI/UX, Illustrator</p>
              <div className="flex justify-center space-x-4 mt-4">
                <a href="https://github.com/zlaraa" className="text-secondary ease-in-out group-hover:text-white text-4xl p-5">
                  <FontAwesomeIcon icon={faGithub}/>
                </a>
                <a href="https://www.linkedin.com/in/nazla-rahma" className="text-secondary ease-in-out group-hover:text-white text-4xl p-5">
                  <FontAwesomeIcon icon={faLinkedin}/>
                </a>
                <a href="https://www.instagram.com/nazlarhm96" className="text-secondary ease-in-out group-hover:text-white text-4xl p-5">
                  <FontAwesomeIcon icon={faInstagram}/>
                </a>
              </div>
            </div>
