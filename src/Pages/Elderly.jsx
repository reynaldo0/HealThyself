...
const Elderly = () => {
  ...
  return (
    <section ref={containerRef} className="pt-24">
          ...
          <div className="flex min-h-[70vh] flex-wrap-reverse items-center">
            <div className="w-full lg:w-1/2">
              <div className="flex flex-col gap-4">
                ...
                >
                  Menyusun rencana kesehatan untuk lansia penting untuk menjaga
                  kualitas hidup dan kesejahteraan mereka. Fokuskan pada nutrisi
                  yang seimbang, aktivitas fisik yang sesuai, dan pemeriksaan
                  kesehatan rutin untuk memastikan lansia tetap sehat dan aktif.
                  Temukan strategi dan tips untuk mengelola kesehatan dengan
                  lebih efektif.
                </p>
        ...
        <div className="container">
          <div className="flex flex-col justify-center items-center gap-5">
            ...
            <p
              ...
              data-aos-easing="ease-in-out"
            >
              Jelajahi panduan lengkap untuk memantau kesehatan lansia. Fokus
              pada pengelolaan penyakit kronis, pencegahan risiko, dan perawatan
              rutin untuk mendukung kualitas hidup mereka. Temukan cara efektif
              untuk menjaga kesehatan fisik dan mental lansia agar tetap aktif
              dan sejahtera.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-start gap-12">
            <div className="flex-1">
              ...
              >
                Pola Makan{" "}
                <span className="text-elderly-light">Saat Lansia</span>
              </h2>
              <p
                ...
                data-aos-duration="800"
              >
                Rencanakan diet bergizi untuk mendukung kesehatan lansia, dengan
                fokus pada makanan yang mudah dicerna dan kebutuhan gizi khusus.
              </p>
              {/* Accordion Section */}
              <div
                data-aos="fade-up"
        ...
        <div className="container">
          <div className="flex flex-col justify-center items-center gap-5">
            <h1
              ...
              data-aos-easing="ease-in-out"
            >
              <span className="text-elderly-dark">Informasi </span> Gizi Saat
              Lansia
            </h1>
            <p
              ...
              data-aos-easing="ease-in-out"
            >
              Nutrisi yang tepat penting untuk kesehatan lansia. Kebutuhan utama
              meliputi protein, serat, lemak sehat, vitamin, dan mineral untuk
              kesehatan tulang, sistem kekebalan, dan energi. Memahami kebutuhan
              gizi membantu memastikan pola makan seimbang yang mendukung
              kualitas hidup dan mencegah penyakit terkait usia.
            </p>
      ...
      <section
        id="imunisasi"
        className="py-20 bg-[url('/background/bg-imunisasi-toska.png')]"
      >
        <div className="container">
          <div className="flex flex-col md:flex-row gap-10">
            <div className="flex flex-col flex-1 gap-5">
              <h1
                className="text-5xl font-bold text-elderly-dark"
                data-aos="fade-up"
                data-aos-easing="ease-in-out"
                data-aos-duration="700"
              >
              ...
              <p
                ...
                data-aos-duration="800"
              >
                Imunisasi lansia penting untuk melindungi dari penyakit. Vaksin
                flu tahunan dan pneumonia, serta vaksin Tdap setiap 10 tahun,
                membantu mencegah infeksi pernapasan dan penyakit serius.
              </p>
            </div>
                  ...
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Tahunan. Melindungi dari flu musiman dan
                        komplikasi terkait.
                      </p>
                    </div>
                  </div>
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Dosis pertama pada usia 65 tahun, dosis kedua 5
                        tahun kemudian. Melindungi dari infeksi pneumonia.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Satu dosis. Melindungi dari herpes zoster
                        (shingles) dan komplikasinya.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Setiap 10 tahun. Melindungi dari tetanus dan
                        difteri.
                      </p>
                    </div>
                  </div>
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Tidak umum untuk lansia. Melindungi dari infeksi
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Jika belum divaksin atau berisiko tinggi.
          ...
          <div className="flex flex-col-reverse md:flex-row h-[100vh] items-center justify-center gap-10">
              ...
              >
                <SwiperSlide>
                  <div className=" bg-white p-4 border-r-8 shadow-md border-elderly-normal">
                    ...
                    <p className="text-tertiary">
                      Berpartisipasi dalam kegiatan sosial dan komunitas dapat
                      meningkatkan suasana hati dan mengurangi rasa kesepian.
                    </p>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="bg-white p-4 border-r-8 shadow-md border-elderly-normal">
                    ...
                    <p className="text-tertiary">
                      Tidur yang cukup dan berkualitas penting untuk kesehatan
                      mental. Ciptakan rutinitas tidur yang konsisten.
                    </p>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="bg-white p-4 border-r-8 shadow-md border-elderly-normal">
                    ...
                    <p className="text-tertiary">
                      Olahraga ringan seperti jalan kaki atau yoga dapat
                      membantu menjaga kesehatan mental dan fisik.
                    </p>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="bg-white p-4 border-r-8 shadow-md border-elderly-normal">
                    ...
                    <p className="text-tertiary">
                      Berbicara dengan keluarga, teman, atau profesional
                      kesehatan dapat membantu mengatasi perasaan cemas atau
                      depresi.
                    </p>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="bg-white p-4 border-r-8 shadow-md border-elderly-normal">
                    ...
                    <p className="text-tertiary">
                      Diet yang sehat dapat mempengaruhi suasana hati dan
                      energi. Pastikan asupan nutrisi yang cukup dan seimbang.
                    </p>
                  </div>
                </SwiperSlide>
              </Swiper>
            ...
            <div className="w-full md:w-1/2 flex items-center">
              <div>
                ...
                >
                  Panduan Perawatan{" "}
                  <span className="text-elderly-normal">Jiwa Lansia</span>
                </h1>
                <p
                  data-aos="fade-up"
                  data-aos-easing="ease-in-out"
                  data-aos-duration="800"
                >
                  "Merawat jiwa lansia penting untuk kesejahteraan mereka.
                  Kesehatan mental yang baik membantu lansia merasa bahagia dan
                  puas. Berikut beberapa tips untuk merawat jiwa lansia.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="lingkungan">
        <div className="w-full bg-white rounded-t-[150px] md:-mt-28 py-20">
          <div className="container">
            ...
            >
              Panduan Lingkungan{" "}
              <span className="text-elderly-normal">Sehat Untuk Lansia</span>
            </h1>
            <p
            ...
            >
              ...
              kesejahteraan lansia. Berikut adalah beberapa hal yang harus
              diperhatikan untuk menciptakan lingkungan yang aman bagi lansia.
            </p>
            ...
            <div
              ...
              data-aos-duration="800"
            >
              <div className="bg-elderly-light/20 group/item hover:bg-elderly-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-elderly-dark group-hover/item:text-white">
                  Ciptakan Ruang yang Terang dan Terang
                </h5>
                <p className="text-sm text-elderly-dark group-hover/item:text-white">
                  Pastikan ruangan memiliki pencahayaan yang cukup untuk
                  menghindari kecelakaan dan meningkatkan kenyamanan. Lampu yang
                  baik juga membantu menjaga kesehatan mata lansia.
                </p>
              </div>

              <div className="bg-elderly-light/20 group/item hover:bg-elderly-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-elderly-dark group-hover/item:text-white">
                  Pastikan Aksesibilitas yang Mudah
                </h5>
                <p className="text-sm text-elderly-dark group-hover/item:text-white">
                  Gunakan pegangan dan ramp untuk membantu mobilitas. Pastikan
                  bahwa lantai bebas dari hambatan yang dapat menyebabkan
                  terjatuh atau kesulitan bergerak.
                </p>
              </div>
              ...
              <div className="bg-elderly-light/20 group/item hover:bg-elderly-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                ...
                <p className="text-sm text-elderly-dark group-hover/item:text-white">
                  Pastikan suhu ruangan tetap stabil dan nyaman. Hindari suhu
                  ekstrem yang dapat mempengaruhi kesehatan lansia, seperti
                  dingin berlebih atau panas berlebih.
                </p>
              </div>

              <div className="bg-elderly-light/20 group/item hover:bg-elderly-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-elderly-dark group-hover/item:text-white">
                  Gunakan Perabot yang Aman dan Stabil
                </h5>
                <p className="text-sm text-elderly-dark group-hover/item:text-white">
                  Pilih perabot yang stabil dan mudah diakses. Hindari perabot
                  yang dapat menyebabkan terjatuh atau kesulitan dalam
              ...
              <div className="bg-elderly-light/20 group/item hover:bg-elderly-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-elderly-dark group-hover/item:text-white">
                  Pastikan Kualitas Udara yang Baik
                </h5>
                <p className="text-sm text-elderly-dark group-hover/item:text-white">
                  Gunakan alat pembersih udara dan pastikan ventilasi yang baik.
                  Kualitas udara yang bersih penting untuk pernapasan dan
              ...
              <div className="bg-elderly-light/20 group/item hover:bg-elderly-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-elderly-dark group-hover/item:text-white">
                  Jaga Kebersihan dan Kerapian Lingkungan
                </h5>
                <p className="text-sm text-elderly-dark group-hover/item:text-white">
                  Pastikan lingkungan selalu bersih dan rapi untuk menghindari
                  risiko infeksi dan cedera. Kebersihan yang baik juga mendukung
                  kesehatan mental dan fisik lansia.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-transparent rounded-md">
                <form>
                  <div className="mb-3 md:mb-7">
                    <input
                      className="w-full px-4 py-5 border bg-[#E5FFF6] border-gray-300 rounded-md"
                      type="text"
                      id="name"
                      data-aos="fade-up"
                      data-aos-easing="ease-in-out"
                  ...
                  <div className="mb-4">
                    <textarea
                      className="w-full px-4 py-2 border bg-[#E5FFF6] border-gray-300 rounded-md"
                      id="message"
                      name="message"
                      data-aos="fade-up"
                      data-aos-easing="ease-in-out"
                  ...
                  >
                    <button
                      type="submit"
                      className="w-full bg-[#2EC38F] text-lg text-white py-5 rounded-xl hover:bg-[#2EC38F]/80 transition duration-300"
                    >
                      Kirim Pesan
                    </button>
                  </div>
      ...
      <Footer backgroundColor="#253B70">
        ...
        <Footer.Source
          link={"http://stikestelogorejo.ac.id"}
          title={"stikestelogorejo"}
        />
        <Footer.Source
          link={"http://nestlehealthscience.co.id"}
          title={"nestlehealth"}
        />
        <Footer.Source
