...
const Adult = () => {
  ...
  return (
    <section ref={containerRef} className="pt-24">
      ...
      <ChatBot
        buttonProps={{
          className: "bg-adult-light hover:bg-adult-light/90",
          children: "Chat",
        }}
      />
          ...
          <div className="flex min-h-[70vh] flex-wrap-reverse items-center">
            <div className="w-full lg:w-1/2">
              <div className="flex flex-col gap-4">
                <h1
                  className="font-bold text-4xl text-adult-dark"
                  data-aos="fade-up"
                ...
                >
                  Di Indonesia, masalah kesehatan serius seperti diabetes (8%)
                  dan hipertensi (30%) diperburuk oleh gaya hidup tidak aktif
                  dan pola makan buruk. Akses terbatas ke layanan kesehatan juga
                  memperburuk kondisi. Fokus pada pencegahan dan promosi gaya
                  hidup sehat sangat penting untuk meningkatkan kualitas hidup.
                </p>

                <HeroButton
                  to="#panduan"
                  circle="bg-adult-normal"
                  textColor="text-adult-normal"
                />
              </div>
            </div>
            <div className="w-full lg:w-1/2 flex justify-center items-end md:items-center min-h-[500px]">
              ...
              >
                <img
                  src="/icons/baby/DEWASA-1.png"
                  alt="Happiness"
                  data-aos="zoom-in"
                  data-aos-easing="ease-in-out"
                  data-aos-duration="1200"
                />
                <p className="font-bold text-xl text-adult-dark text-center">
                  Bahagia
                </p>
              </div>
      ...
      <section id="panduan" className="min-h-[70vh] py-28">
        <div className="container">
          <div className="flex flex-col justify-center items-center gap-5">
            <h1
              className="text-adult-normal font-bold text-4xl text-center"
              data-aos="fade-up"
              data-aos-easing="ease-in-out"
              data-aos-duration="700"
            >
              <span className="text-adult-dark">Pantau </span>{" "}
              <span className="underline-box after:bg-adult-normal/20">
            ...
            <p
              ...
              data-aos-easing="ease-in-out"
            >
              Jelajahi panduan kami untuk memahami kesehatan dewasa, termasuk
              manajemen stres, pencegahan penyakit, dan tips untuk gaya hidup
              sehat. Temukan cara menjaga kesehatan tubuh dan pikiran serta
              strategi menghadapi tantangan kesehatan dewasa.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start gap-12">
            <div className="flex-1">
              <h2
                ...
                data-aos-duration="700"
              >
                Rencana <span className="text-white">Makan Seimbang </span>
              </h2>
              <p
                ...
                data-aos-duration="800"
              >
                Menyusun rencana kesehatan yang efektif memastikan kesejahteraan
                fisik dan mental optimal. Temukan strategi untuk gaya hidup
                sehat, pengelolaan stres, dan peningkatan kualitas hidup.
              </p>
              {/* Accordion Section */}
              <div
                data-aos="fade-up"
        ...
        <div className="container">
          <div className="flex flex-col justify-center items-center gap-5">
            <h1
              ...
              data-aos-easing="ease-in-out"
            >
              <span className="text-adult-dark">Informasi </span>{" "}
              <span className="underline-box after:bg-adult-normal/20">
                Gizi Orang Dewasa
              </span>
            </h1>
            <p
              ...
              data-aos-easing="ease-in-out"
            >
              Nutrisi yang tepat penting untuk kesehatan dewasa. Protein
              mendukung pemeliharaan otot, karbohidrat kompleks memberikan
              energi berkelanjutan, lemak sehat mendukung kesehatan jantung dan
              otak, serta vitamin dan mineral penting untuk fungsi tubuh yang
              optimal. Memenuhi kebutuhan gizi ini membantu menjaga kesehatan
      ...
      <section
        id="imunisasi"
        className="py-20 bg-[url('/background/bg-imunisasi-orange.png')]"
      >
        <div className="container">
          <div className="flex flex-col md:flex-row gap-10">
            <div className="flex flex-col flex-1 gap-5">
              <h1
                className="text-5xl font-bold text-adult-dark"
                data-aos="fade-up"
                data-aos-easing="ease-in-out"
                data-aos-duration="700"
              >
                Usia{" "}
                <span className="text-adult-normal">Efektif Imunisasi</span>{" "}
                Dewasa
              </h1>
              <p
                ...
                data-aos-duration="800"
              >
                Imunisasi dewasa penting untuk mencegah penyakit menular. Vaksin
                flu, Tdap, herpes zoster, dan pneumokokus direkomendasikan,
                terutama untuk usia di atas 50 tahun, guna mendukung kesehatan
                jangka panjang.
              </p>
            </div>
              ...
              >
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    <div className="flex-1">
                      <img
                        src="/assets/carousel/baby/Vaksin-Influenza.jpg"
                        alt="Vaksin Influenza"
                      />
                    </div>
                    <div className="flex-[2]">
                      <h1 className="text-adult-dark font-bold text-3xl mb-4">
                        Vaksin Influenza
                      </h1>
                      <p className="text-tertiary text-sm">
                        Jadwal: Tahunan. Vaksin ini mencegah flu musiman. Banyak
                        dewasa melewatkannya, meningkatkan risiko flu dan
                        komplikasi.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    <div className="flex-1">
                      <img
                        ...
                        alt="Vaksin Tetanus-diphtheria"
                      />
                    </div>
                    <div className="flex-[2]">
                      <h1 className="text-adult-dark font-bold text-3xl mb-4">
                        Vaksin Tetanus-diphtheria (Td)
                      </h1>
                      <p className="text-tertiary text-sm">
                        Jadwal: Booster setiap 10 tahun. Keterlambatan booster
                        dapat menurunkan kekebalan, meningkatkan risiko infeksi.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Usia 65 tahun atau lebih awal jika berisiko.
                        Vaksin ini mencegah pneumonia dan infeksi paru-paru.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    <div className="flex-1">
                      <img
                        src="/assets/carousel/baby/Vaksin-HEPATITIS-B.jpg"
                        alt="Vaksin Hepatitis B"
                      />
                    </div>
                    <div className="flex-[2]">
                      <h1 className="text-adult-dark font-bold text-3xl mb-4">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Dosis lengkap jika belum pernah atau berisiko
                        tinggi. Melindungi dari infeksi hepatitis B.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
      ...
      <section
        id="perawatan"
        className="md:bg-[url('/background/wave-orange.png')] bg-cover md:h-[150vh]"
      >
        <div className="container">
          <div className="flex flex-col-reverse md:flex-row h-[100vh] items-center justify-center gap-10">
              ...
              >
                <SwiperSlide>
                  <div className="bg-white p-4 border-r-8 shadow-md border-adult-normal">
                    ...
                    <p className="text-tertiary">
                      Meditasi, pernapasan dalam, atau yoga dapat mengurangi
                      stres dan meningkatkan kesejahteraan mental. Luangkan
                      waktu setiap hari untuk teknik ini.
                    </p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="bg-white p-4 border-r-8 shadow-md border-adult-normal">
                    ...
                    <p className="text-tertiary">
                      Tetapkan batas waktu kerja dan luangkan waktu untuk
                      aktivitas pribadi untuk mengurangi stres dan kelelahan.
                    </p>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="bg-white p-4 border-r-8 shadow-md border-adult-normal">
                    ...
                    <p className="text-tertiary">
                      Hubungan yang sehat dengan keluarga dan teman meningkatkan
                      dukungan emosional dan kebahagiaan. Investasikan waktu
                ...
                <SwiperSlide>
                  <div className="bg-white p-4 border-r-8 shadow-md border-adult-normal">
                    ...
                    <p className="text-tertiary">
                      Jadwalkan waktu untuk hobi dan istirahat untuk menjaga
                ...
                <SwiperSlide>
                  <div className="bg-white p-4 border-r-8 shadow-md border-adult-normal">
                    ...
                    <p className="text-tertiary">
                      Gunakan teknik seperti menulis jurnal atau berbicara
                      dengan profesional untuk mengelola emosi secara efektif.
                    </p>
                  </div>
                </SwiperSlide>
              </Swiper>
            ...
            <div className="w-full md:w-1/2 flex items-center mt-20">
              <div>
                <h1
                  className="text-adult-dark font-bold text-4xl mb-4"
                  data-aos="fade-up"
                  data-aos-easing="ease-in-out"
                  data-aos-duration="700"
                >
                  Panduan Menjaga{" "}
                  <span className="text-adult-normal">Jiwa Saat Dewasa</span>
                </h1>
                <p
                  data-aos="fade-up"
                  data-aos-easing="ease-in-out"
                  data-aos-duration="800"
                >
                  Merawat kesehatan jiwa dewasa melibatkan pengelolaan stres,
                  keseimbangan kerja-hidup, dan hubungan sosial positif.
                  Luangkan waktu untuk aktivitas menyenangkan dan cari dukungan
                  profesional jika perlu. Ini semua penting untuk kesehatan
                  mental dan kualitas hidup yang lebih baik.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="lingkungan">
        <div className="w-full bg-white rounded-t-[150px] md:-mt-28 py-20">
          <div className="container">
            <h1
              className="text-4xl font-bold text-adult-dark text-center mb-4"
              data-aos="fade-up"
              data-aos-easing="ease-in-out"
              data-aos-duration="700"
            >
              Panduan Lingkungan{" "}
              <span className="text-adult-normal underline-box after:bg-adult-normal/20">
                Sehat untuk Orang{" "}
              </span>
            </h1>
            <p
              ...
              data-aos-duration="800"
            >
              Menjaga lingkungan yang sehat dan aman sangat penting untuk
              mendukung kesejahteraan orang dewasa. Lingkungan yang bersih,
              teratur, dan bebas dari stres dapat meningkatkan kualitas hidup
              dan kesehatan secara keseluruhan. Temukan cara untuk menciptakan
              ruang yang mendukung kesehatan mental dan fisik Anda dengan
              menghindari faktor-faktor risiko seperti polusi, kekacauan, dan
              stres berlebihan.
            </p>
            ...
            >
              <div className="bg-adult-normal/20 group/item hover:bg-adult-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-adult-normal group-hover/item:text-white">
                  Ciptakan Ruang Kerja Ergonomis
                </h5>
                <p className="text-sm text-adult-normal group-hover/item:text-white">
                  Atur kursi dan meja agar nyaman untuk mencegah masalah postur
                  dan nyeri punggung.
                </p>
              </div>
              ...
              <div className="bg-adult-normal/20 group/item hover:bg-adult-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-adult-normal group-hover/item:text-white">
                  Jaga Kebersihan dan Ventilasi
                </h5>
                <p className="text-sm text-adult-normal group-hover/item:text-white">
                  Bersihkan debu dan pastikan ventilasi baik untuk mencegah
                  masalah pernapasan dan meningkatkan kenyamanan.
                </p>
              </div>
              ...
              <div className="bg-adult-normal/20 group/item hover:bg-adult-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                ...
                <p className="text-sm text-adult-normal group-hover/item:text-white">
                  Hindari polusi dan bahan kimia berbahaya dengan memilih produk
                  ramah lingkungan dan menggunakan filter udara.
                </p>
              </div>

              <div className="bg-adult-normal/20 group/item hover:bg-adult-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-adult-normal group-hover/item:text-white">
                  Rencanakan Ruang Relaksasi
                </h5>
                <p className="text-sm text-adult-normal group-hover/item:text-white">
                  Ciptakan area tenang dengan tanaman, pencahayaan lembut, dan
                  perabot nyaman untuk mengurangi stres.
                </p>
              </div>

              <div className="bg-adult-normal/20 group/item hover:bg-adult-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-adult-normal group-hover/item:text-white">
                  Implementasikan Pola Hidup Sehat
                </h5>
                <p className="text-sm text-adult-normal group-hover/item:text-white">
                  Adopsi gaya hidup sehat dengan menu seimbang, olahraga rutin,
                  dan area untuk aktivitas fisik di rumah.
                </p>
              </div>

              <div className="bg-adult-normal/20 group/item hover:bg-adult-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-adult-normal group-hover/item:text-white">
                  Prioritaskan Keamanan Rumah
                </h5>
                <p className="text-sm text-adult-normal group-hover/item:text-white">
                  Jaga keamanan rumah dengan mengatasi bahaya seperti permukaan
                  licin, kabel berserakan, dan peralatan rusak. Pasang alat
                  pemadam kebakaran dan detektor asap.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="gizi" className="bg-adult-dark py-12 relative z-20">
              ...
              <div className="bg-transparent rounded-md">
                <form>
                  <div className="mb-3 md:mb-7">
                    <input
                      className="w-full px-4 py-5 border bg-[#FFEDE6] border-gray-300 rounded-md"
                      type="text"
                      id="name"
                      data-aos="fade-up"
                      data-aos-easing="ease-in-out"
                  ...
                  <div className="mb-4">
                    <textarea
                      className="w-full px-4 py-2 border bg-[#FFEDE6] border-gray-300 rounded-md"
                      id="message"
                      name="message"
                      data-aos="fade-up"
                      data-aos-easing="ease-in-out"
                  ...
                  >
                    <button
                      type="submit"
                      className="w-full bg-[#FF9F79] text-lg text-white py-5 rounded-xl hover:bg-[#FF9F79]/80 transition duration-300"
                    >
                      Kirim Pesan
                    </button>
                  </div>
      ...
      <Footer backgroundColor="#253B70">
        ...
        <Footer.Source
          link={"http://dinkes.kalbarprov.go.id"}
          title={"dinkes.kalbar"}
        />
        <Footer.Source
          link={"http://telemed.ihc.id"}
          title={"telemed.ihc.id"}
        />
        <Footer.Source
          link={"http://biofarma.co.id"}
          title={"biofarma.co.id"}
        />
      </Footer>
    </section>
  );
