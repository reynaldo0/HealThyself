  ...
  return (
    <section className="relative min-h-screen">
      ...
      <div className="relative z-10 px-16 bg-transparent mx-auto max-w-screen-xl flex">
        ...
        <div className="absolute -bottom-11 left-20 transform -translate-y-1/2 flex items-center space-x-2">
          ...
          <span className="text-black font-semibold opacity-50 hover:opacity-100">Kembali</span>
        </div>

        <div className="relative gap-5">
          <button
            onClick={handlePrev}
            className="absolute -bottom-16 right-20 transform -translate-y-1/2 bg-transparent border-secondary border-2 text-white p-2 rounded-full shadow-lg hover:border-primary"
          >
          ...
          <button
            onClick={handleNext}
            className="absolute -bottom-16 right-4 transform -translate-y-1/2 bg-transparent border-secondary border-2 text-white p-2 rounded-full shadow-lg hover:border-primary"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
