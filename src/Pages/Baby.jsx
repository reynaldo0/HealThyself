...
const Baby = () => {
  ...
  return (
    <section ref={containerRef} className="pt-24">
          ...
          <div className="flex min-h-[70vh] flex-wrap-reverse items-center">
            <div className="w-full lg:w-1/2">
              <div className="flex flex-col gap-4">
                <h1
                  className="font-bold text-4xl text-baby-dark"
                  data-aos="fade-up"
                ...
                >
                  Permasalahan gaya hidup dan kesehatan bayi di Indonesia
                  mencakup stunting pada 30% bayi, rendahnya cakupan ASI
                  eksklusif, dan masih tingginya kasus ISPA yang berkontribusi
                  pada kematian bayi. Kurangnya pola makan sehat, sanitasi yang
                  buruk, dan cakupan imunisasi yang belum optimal menjadi
                  tantangan utama.
                </p>
            ...
            <div className="w-full lg:w-1/2 flex justify-center items-end md:items-center min-h-[500px]">
              ...
              {/* card glassmorphism */}
              <div
                className="hidden md:block absolute w-[150px] h-[190px] bg-white/40 backdrop-blur-3xl border border-white rounded-[34px] right-40 top-10 p-4"
                data-aos="fade-up"
                data-aos-easing="ease-in-out"
                data-aos-duration="700"
              >
                <img
                  src="/icons/baby/susu.png"
                  alt="Health"
                  data-aos="zoom-in"
                  data-aos-easing="ease-in-out"
              ...
              <div
                className="hidden md:block absolute w-[150px] h-[190px] bg-white/30 border backdrop-blur-3xl border-white rounded-[34px] right-[500px] top-[300px] p-4 shadow-md"
                data-aos="fade-up"
                data-aos-easing="ease-in-out"
                data-aos-duration="800"
              >
      ...
      <section id="panduan" className="min-h-[70vh] py-28">
        <div className="container">
          <div className="flex flex-col justify-center items-center gap-5">
            <h1
              className="text-baby-normal font-bold text-4xl text-center"
              data-aos="fade-up"
              data-aos-easing="ease-in-out"
              data-aos-duration="700"
            >
              <span className="text-baby-dark">Pantau Perkembangan</span>{" "}
              <span className="underline-box after:bg-baby-normal/20">
                Bayi Ideal
              </span>
            </h1>
            <p
              ...
              data-aos-easing="ease-in-out"
            >
              Pantau perkembangan bayi dengan panduan ini untuk memahami tahapan
              penting seperti fisik, motorik, dan bahasa. Dapatkan informasi dan
              tips untuk mendukung pertumbuhan bayi di setiap tahap usianya.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-start gap-12">
            <div className="flex-1">
              ...
              >
                {" "}
                Gizi Bayi <span className="text-baby-vlight">Tercukupi</span>
              </h2>
              <p
        ...
        <div className="container">
          <div className="flex flex-col justify-center items-center gap-5">
            <h1
              ...
              data-aos-easing="ease-in-out"
            >
              <span className="text-baby-dark">Informasi </span>{" "}
              <span className="underline-box after:bg-baby-normal/20">
                Gizi Bayi
              </span>
            </h1>
            <p
              ...
              data-aos-easing="ease-in-out"
            >
              Nutrisi yang tepat penting untuk pertumbuhan dan perkembangan
              bayi. Informasi gizi mencakup kebutuhan utama seperti protein,
              karbohidrat, lemak sehat, vitamin, dan mineral untuk mendukung
              kesehatan dan energi mereka. Memahami kebutuhan ini memastikan
              makanan yang seimbang untuk perkembangan fisik dan mental optimal.
            </p>
      ...
      <section
        id="imunisasi"
        className="py-20 bg-[url('/background/bg-imunisasi.png')]"
      >
        <div className="container">
          <div className="flex flex-col md:flex-row gap-10">
            <div className="flex flex-col flex-1 gap-5">
              <h1
                className="text-5xl font-bold text-baby-dark"
                data-aos="fade-up"
                data-aos-easing="ease-in-out"
                data-aos-duration="700"
              >
                {" "}
                <span className="text-baby-normal">
              ...
              <p
                ...
                data-aos-duration="800"
              >
                Imunisasi bayi dimulai sejak lahir dengan vaksin Hepatitis B dan
                BCG, dilanjutkan dengan Polio, DTP, dan Hib pada usia 2-4 bulan,
                serta MMR pada usia 12 bulan untuk perlindungan optimal dari
                penyakit serius.
              </p>
            </div>
              ...
              >
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    <div className="flex-1">
                      <img
                        src="/assets/carousel/baby/hepatis.jpg"
                        alt="Immunization"
                      />
                    </div>
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Dosis pertama setelah lahir, kedua pada 1-2
                        bulan, dan ketiga pada 6-18 bulan. Melindungi dari
                        infeksi hepatitis B yang dapat merusak hati.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Setelah lahir. Melindungi dari tuberkulosis (TB)
                        yang dapat mempengaruhi paru-paru dan organ lain.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Dosis pertama pada 2 bulan, kedua pada 4 bulan,
                        ketiga pada 6 bulan, dan keempat pada 18 bulan. Mencegah
                        poliomielitis.
                      </p>
                    </div>
                  </div>
                ...
                <SwiperSlide>
                  <div className="w-full h-full bg-white rounded-lg p-8 md:p-5 flex flex-col items-center md:flex-row overflow-hidden gap-5 md:gap-10">
                    ...
                    <div className="flex-[2]">
                      ...
                      <p className="text-tertiary text-sm">
                        Jadwal: Dosis pertama pada 2 bulan, kedua pada 4 bulan,
                        ketiga pada 6 bulan, dan keempat pada 12-15 bulan.
                        Melindungi dari infeksi bakteri yang dapat menyebabkan
                        penyakit serius.
                      </p>
                    </div>
                  </div>
        ...
        <div className="container">
          <div className="flex flex-col-reverse md:flex-row h-[100vh] items-center justify-center gap-10">
            ...
            <div className="w-full md:w-1/2 flex items-center mt-20">
              <div>
                <h1
                  className="text-baby-dark font-bold text-4xl mb-4"
                  data-aos="fade-up"
                  data-aos-easing="ease-in-out"
                  data-aos-duration="700"
                >
                  Membangun Fondasi{" "}
                  <span className="text-baby-light">Kesehatan Mental</span>
                </h1>
                <p
                  data-aos="fade-up"
                  data-aos-easing="ease-in-out"
                  data-aos-duration="800"
                >
                  Merawat kesehatan mental bayi penting untuk perkembangan
                  emosional. Perhatian dan kasih sayang membantu bayi tumbuh
                  menjadi anak yang percaya diri dan seimbang.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="lingkungan">
        <div className="w-full bg-white rounded-t-[150px] md:-mt-28 py-20">
          <div className="container">
            <h1
              className="text-4xl font-bold text-baby-dark text-center mb-4"
              data-aos="fade-up"
              data-aos-easing="ease-in-out"
              data-aos-duration="700"
            >
              Lingkungan Sehat{" "}
              <span className="text-baby-light underline-box after:bg-baby-normal/20">
                Fondasi Kesehatan Bayi Anda
              </span>
            </h1>
            <p
              ...
              data-aos-duration="800"
            >
              Jaga kebersihan, keamanan, serta kenyamanan untuk mendukung
              pertumbuhan bayi. Ikuti langkah-langkah penting setiap hari untuk
              kesehatan optimal bayi Anda.
            </p>
            ...
            <div
              ...
              data-aos-duration="800"
            >
              <div className="bg-baby-vlight/20 group/item hover:bg-baby-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-baby-normal group-hover/item:text-white">
                  Pastikan Kebersihan Udara di Sekitar Bayi
                </h5>
                <p className="text-sm text-baby-light group-hover/item:text-white">
                  Hindari asap rokok, debu, dan polusi. Gunakan pembersih udara
                  dan pastikan ventilasi ruangan baik.
                </p>
              </div>
              ...
              <div className="bg-baby-vlight/20 group/item hover:bg-baby-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                ...
                <p className="text-sm text-baby-light group-hover/item:text-white">
                  Gunakan kasur rata dan hindari bantal atau selimut tebal untuk
                  mencegah SIDS.
                </p>
              </div>
              ...
              <div className="bg-baby-vlight/20 group/item hover:bg-baby-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                ...
                <p className="text-sm text-baby-light group-hover/item:text-white">
                  Pastikan air yang dikonsumsi bayi bersih dan aman, gunakan air
                  matang atau kemasan jika perlu.
                </p>
              </div>
              ...
              <div className="bg-baby-vlight/20 group/item hover:bg-baby-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                ...
                <p className="text-sm text-baby-light group-hover/item:text-white">
                  Jauhkan produk kimia berbahaya dari jangkauan bayi, simpan di
                  tempat aman.
                </p>
              </div>
              ...
              <div className="bg-baby-vlight/20 group/item hover:bg-baby-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-baby-normal group-hover/item:text-white">
                  Produk Perawatan Aman
                </h5>
                <p className="text-sm text-baby-light group-hover/item:text-white">
                  Pilih produk bebas bahan kimia berbahaya dan hypoallergenic.
                </p>
              </div>

              <div className="bg-baby-vlight/20 group/item hover:bg-baby-dark px-10 py-5 min-h-[180px] transition flex-col flex items-center justify-center text-center group-hover:opacity-100 group-hover:text-white hover:scale-105">
                <h5 className="font-semibold mb-2 text-baby-normal group-hover/item:text-white">
                  Amankan Sudut Furnitur
                </h5>
                <p className="text-sm text-baby-light group-hover/item:text-white">
                  Gunakan pelindung untuk sudut tajam dan tepi furnitur untuk
                  mencegah cedera bayi.
                </p>
              </div>
            </div>
          </div>
